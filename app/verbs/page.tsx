...
export default function VerbsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-teal-50 pb-20">
      <Navbar />
      
      <div className="max-w-4xl mx-auto pt-36 px-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <button 
