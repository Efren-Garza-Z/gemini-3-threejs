        ...
        <main className="h-screen w-screen bg-gradient-to-br from-[#ffecd2] via-[#fcb69f] to-[#ff9a9e] flex flex-col items-center justify-center p-6">
            ...
            <div className="mt-6 max-w-md">
                <button
                    ...
                    className="bg-gradient-to-br from-indigo-500/40 to-purple-500/40 backdrop-blur-md p-8 rounded-[2.5rem] border border-white/50 shadow-xl hover:shadow-2xl hover:scale-[1.03] transition-all text-left group flex flex-col h-full relative overflow-hidden"
                >
